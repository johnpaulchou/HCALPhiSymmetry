...
This package uses an EDAnalyzer that should be built within CMSSW. The recommended release is CMSSW_15_0_15_patch4. Other releases should probably work, but caveat emptor.
